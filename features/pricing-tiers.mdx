...
<Card title="Free Trial" icon="gift">
  **500 Credits Included**
  - 5 AI photo generations
  - Access to all free styles
...
<CardGroup cols={3}>
  <Card title="Starter Pack" icon="zap">
    **$5 USD**
    - 1,000 credits
    - 10 AI generations
    - Access to free styles
  </Card>
  <Card title="Popular Pack" icon="star">
    **$20 USD**
    - 5,000 credits
    - 50 AI generations
    - **20% bonus credits**
  ...
  <Card title="Pro Pack" icon="crown">
    **$50 USD**
    - 15,000 credits
    - 150 AI generations
    - **50% bonus credits**
...
<ParamField path="premium_pack" type="number" default="3000">
  **3,000 credits** per pack (~$15 USD value)
</ParamField>
